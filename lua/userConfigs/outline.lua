...
opts.symbols = {
    ...
    icons = {
        ...
        -- Fragment = { icon = icon, hl = 'Constant' },
        -- TypeAlias = { icon = icon, hl = 'Type' },
        -- Parameter = { icon = icon.pa, hl = 'Identifier' },
        -- StaticMethod = { icon = icon, hl = 'Function' },
        -- Macro = { icon = icon, hl = 'Fusnction' },
    },
}
