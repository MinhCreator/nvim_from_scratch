...
map("n","<leader>mdt", "<cmd>DapViewToggle<cr>", { desc = "Toggle Dap view" })
map("n", "<leader>mdb", "<cmd>DapToggleBreakpoint<cr>", { desc = "Toggle breakpoint" })
map("n", "<leader>mdc", "<cmd>DapContinue<cr>", { desc = "continues dap" })
map("n","<leader>mdw", "<cmd>DapViewWatch<cr>", { desc = "Toggle Dap view watch" })
map("n","<leader>mdo", "<cmd>lua require('dapui').toggle()<cr>", { desc = "Toggle Dap UI" })
