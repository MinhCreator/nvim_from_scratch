return {
    {
        ...
        keys = {
            ...
            -- LSP
            { "<leader>sgd", function() Snacks.picker.lsp_definitions() end, desc = "Goto Definition" },
            { "<leader>sgD", function() Snacks.picker.lsp_declarations() end, desc = "Goto Declaration" },
            { "<leader>sgr", function() Snacks.picker.lsp_references() end, nowait = true, desc = "References" },
            { "<leader>sgI", function() Snacks.picker.lsp_implementations() end, desc = "Goto Implementation" },
            { "<leader>sgy", function() Snacks.picker.lsp_type_definitions() end, desc = "Goto T[y]pe Definition" },
